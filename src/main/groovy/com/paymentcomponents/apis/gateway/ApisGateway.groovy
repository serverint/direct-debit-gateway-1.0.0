package com.paymentcomponents.apis.gateway

import com.google.common.base.Predicate
import com.paymentcomponents.apis.gateway.interceptor.CustomHandlerInterceptor

import com.paymentcomponents.apis.gateway.kafka.interfaces.DirectDebitsChannel
import com.paymentcomponents.apis.gateway.kafka.interfaces.LogsChannel
...
@Configuration
@EnableBinding([LogsChannel.class, DirectDebitsChannel.class])
@IntegrationComponentScan
@EnableSwagger2
class ApisGateway extends WebMvcConfigurerAdapter {
	...
	static void main(String[] args) {
        SpringApplication.run ApisGateway, args
	}
